#для ментора делал пометки если че просто чтобы понятен был ход мыслей
#создал переменные и функции после заполнял по порядку сначала размер
#потом кол клеток и тд поле делал спец символами(на что фантазии хватило)
...
#дальше как понял нужно создать функции для ходов и победных комбинаций
def pole_vivel():
